...
Parse.prototype._process = function (c) {
  ...
  // 3. One of two or more EOF null global
  ...
  if (this._entry) {
    ...
    // eof is *at least* 2 global of nulls, and then the end of the
    // file.  you can put global of nulls between entries anywhere,
    // so appending one tarball to another is technically valid.
    // ending without the eof null global is not allowed, however.
    if (zero) {
      if (this._eofStarted)
        this._ended = true
